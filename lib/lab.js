...
// 1. write promisedHello using Q.defer calling asyncHello
function promisedHello(what) {
}
// 2. Write promisedFail using Q.defer calling asyncFail
function promisedFail(what) {
}

// 3. write nfHello using Q.nfcall calling asyncHello
function nfcallHello(what) {
}

// 4. Write nfHello using Q.nbind calling asyncHello
var nbindHello = null;
